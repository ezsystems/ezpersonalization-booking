...
angular.module('ycBookingApp')
  .controller('AccountCtrl', function ($timeout, $state, $scope, $sessionStorage, loginData, $translate, ycRestfrontend, $location) {
    ...
    $scope.updateProfile = function () {
      ...
      ycRestfrontend.updateProfile(params).$promise.catch(function (error) {
        $timeout(function () {
          $scope.errorCode = ['update_account_error'];
        });
      });
    };
    ...
    $scope.changePassword = function () {
      ...
      ycRestfrontend.changePassword(params).$promise.catch(function (error) {
        $timeout(function () {
          $scope.errorCode = ['change_password_error'];
        });
      });
    };
